...
var Facts = {
  ...
  painting_content: [
    ...
    "vintage can of pickles",
    "tower of Babel",
    "secret human civilization inside a blooming flower",
    "alien houseplant",
    "electric sheep",
    "bouquet of flowers",
    "green family of dolphins",
    "group of old friends with straw hats",
    "godess of Love",
  ],
  ...
  painting_content_CZ: [
    ...
    "vinobraní plechovky okurek",
    "Babylonské věže",
    "tajné lidské civilizace v rozkvetlé květině",
    "mimozemské pokojové rostliny",
    "elektrické ovce",
    "kytice květin",
    "zelené rodiny delfínů",
    "skupiny starých přátel se slaměnými klobouky",
    "bohyně lásky",
  ],

  painting_content_DE: [
    "von der marslandschaft",
    "von einem porträt eines richters",
    "von einem stillleben aus früchten",
    "von einem orangefarbenen elefanten",
    "von einem altmodischen gewächshaus",
    "von einer altmodischen dose Gurken",
    "vom Turm zu Babel",
    "einer geheimen menschlichen Zivilisation in einer blühenden Blume",
    "einer außerirdischen Zimmerpflanze",
    "elektrischen Schafen",
    "einem Blumenstrauß",
    "einer grünen Delfinfamilie",
    "einer Gruppe alter Freunde mit Strohhüten",
    "der Liebesgöttin",
  ],
  ...
  painting_setting: [
    "from a distance",
    "during a sunset",
    "in a poppy field at noon",
    "in the French countryside",
    "by the sea",
    "during the last day on Earth",
    "before the storm",
    "in the poolclub",
    "underwater",
    "in a stadium",
  ...
  painting_setting_CZ: [
    "z dálky",
    "při západu slunce",
    "v poledne v makovém poli",
    "na francouzském venkově",
    "u moře",
    "během posledního dne na Zemi",
    "před bouří",
    "v klubu u bazénu",
    "pod vodou",
    "na stadionu",
  ...
  painting_setting_DE: [
    ...
    "mittags in einem Mohnfeld",
    "in der französischen Landschaft",
    "am Meer",
    "während des letzten Tages auf Erden",
    "vor dem Sturm",
    "im Poolclub",
    "unter Wasser",
    "in einem Stadion",
  ...
  sculpture_content: [
    ...
    "cup of eternal life",
    "t-rex with short legs and long arms",
  ],
...
var Prompts = {
  ENG: {
    ...
    painting: {
      ...
      1: [
        "There are endless possibilities of what to do on a canvas. Now, which one will it be?",
      ],
      2: [
        "Now we can start filling it in. Think of things, characters - truly anything. Go ahead, dream away:",
      ],
      3: [
        "Where is this scene set? Is there even a setting?",
      ],
      4: [
        "Canvases will often radiate some energy. Think of emotions and energies you would want to convey through your artwork!",
      ],
      5: [
        "There are endless styles in the world of art - these either help bring out the visuality of your scene, or better communicate the desired message.",
      ],
      6: [
        "Is there someone, or something that you admire and wish to follow in their footsteps? Perhaps you will want to finish you artwork off in the style of…",
      ],
    },
    sculpture: {
      lookup: [
